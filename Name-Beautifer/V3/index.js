// Version 3, added a button to change "Pumpkin" text to show the name of the current font family. 
// Clicking "Click to see font name" button will swap out the word "Pumpkin" to the name of current font family.
...
// var to get the id of Change button
const changePumpkinBtn = document.getElementById("changeBtn")
...
//var to store name (starts as Pumpkin) to display new font name
let beautifiedName = document.getElementById("name");
...
function loadEventListeners () {
    ...
    // Change "Change Font " button color event
    changePumpkinBtn.addEventListener('click', changeP2FNButton)
  }
...
// Change Font Color - Figures out which color to use next.
    function changeFontColor () {
        ...
        function hexToRGBA(hex, opacity) {
            ...
            //Change the "Change" button background color to match the "Pumpkin" font color, but with 50% opacity
            changePumpkinBtn.style.backgroundColor = (hexToRGBA(rgbaColor));
            //changePumpkinBtn.style.backgroundColor = (fontsColorArr[currentColor]);
            beautifiedName = (fontsArr[nextFont]);
        }
...
// Change Buttons font to Match Font Family & Weight
    function changeBNButton () {
        ...
        // change "Change" button font family
        changePumpkinBtn.style.fontFamily = (nameToBeBeautified.style.fontFamily);
        // change "Change" button font weight
        changePumpkinBtn.style.fontWeight = (nameToBeBeautified.style.fontWeight);
        // Reset font name text back to default "Pumpkin" text.
        nameToBeBeautified.innerHTML = "Pumpkin";
        } 

// Change "Pumpkin" text to read the name of current font       
        function changeP2FNButton () {
            nameToBeBeautified.innerHTML = (beautifiedName);
        }